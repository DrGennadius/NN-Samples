...
//            var perceptron3 = new PerceptronOld(2, 5, 1);
//            PerceptronTrainerOld perceptronTrainerOld = new PerceptronTrainerOld();
//            var p = new PerceptronBase(perceptron3);

//            perceptronTrainerOld.Train(perceptron3, TrainData.GenerateDataAND(), 0.5, 1e-10, 1000000, false);
...
//            TestPerceptronBase(p, "Perceptron Base");
...
//            var perceptronTrainer = new PerceptronTrainerOld();
...
//            TestLogic(perceptron, TrainData.GenerateDataSimpleNumbers(), "SimpleNumbers");
//        }
...
//        public static void TestReadyModel(IPerceptronBase perceptron, TrainData trainData, string separateInput, IORanges ranges, TestReadyModelMode mode = TestReadyModelMode.LeftIsTargetInput)
//        {
...
//            {
//                double[][] row = trainData.GetRow(i);
//                double[] output = perceptron.Forward(row[0]);
//                double[] scaledInput = CommonFunctions.Scale(row[0], inputActivationFunction.InputRange, ranges.InputRange);
//                double[] scaledOutput = CommonFunctions.Scale(output, outputActivationFunction.OutputRange, ranges.OutputRange);
//                Console.WriteLine(
//                    "{0} = {1}", 
//                    string.Join(separateInput, scaledInput), 
//                    string.Join(" ", scaledOutput.Select(x => Math.Round(x, 2)))
//                    );
//            }
//        }
